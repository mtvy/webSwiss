<?php
/*
 * trait.MedLabAdminOptions.php
 */

trait MedLabAdminOptions {
    public $options=[];
/*=======================*/
//https://wp-kama.ru/function/add_settings_field
    ...
    public function parser_options_descrtiption(){
        echo '<b>MedLab - основные настройки</b>';
    }
    public function parser_options_descrtiption_delivery(){
        echo '<b>MedLab - настройки доставки</b>';
    }
    public function parser_options_descrtiption_blankinfo(){
        echo '<b>MedLab - информация в бланке</b>';
    }
...
//        register_setting( $this->page, $option_name);
        register_setting( $page, $option_name);
        // добавляем поле
        $_arg = array( 
                'id' => $option_name, 
    ...
    public function add_option_field_to_general_admin_page(){
        $id_block = 'medlab_main_settings';
        $title = 'Настройки MedLab';
    ...
    $option_name = 'medlab_connect_port';
    $option_title = 'Port';
    $option_field = 'input';
    $items = [];
    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    ...
    $option_name = 'medlab_connect_sender';
    $option_title = 'Sender';
    $option_field = 'input';
    $items = [];
    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    ...
    $option_name = 'medlab_connect_pass';
    $option_title = 'Passwort';
    $option_field = 'input';
    $items = [];
    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    $arg = array(
    ...
    /*      /  main        */
        ...
        $id_block = 'medlab_delivery_settings';
        $title = 'Настройки MedLab: Доставка';
        $callback = [$this,'parser_options_descrtiption_delivery'];
        $page = 'general';
        $page = $this->page.'_delivery';
        add_settings_section( $id_block, $title, $callback, $page );
        
    /*        delivery        */

    $option_name = 'ml_delivery_report_mails';
    $option_title = 'delivery report mails';
    ...
    $option_name = 'ml_delivery_report_active';
    $option_title = 'Отправлять отчёт о доставке';
    $option_field = 'select';
//    $items = [];
//    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    $arg = array(
    ...
    /*      /  delivery        */
        ...
        $id_block = 'medlab_blankinfo_settings';
        $title = 'Настройки MedLab: Информация в бланке';
        $callback = [$this,'parser_options_descrtiption_blankinfo'];
        $page = 'general';
        $page = $this->page.'_blankinfo';
        add_settings_section( $id_block, $title, $callback, $page );
        
    /*        blankinfo        */

    $option_name = 'ml_blankinfo_bottom_text';
    $option_title = 'блок текста в бланке пациента';
    $option_field = 'textarea';
    $items = [];
    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    $arg = array(
    ...
    do_action('medlab_options_add_field', $this, $page, $id_block);
    if(1)return;
