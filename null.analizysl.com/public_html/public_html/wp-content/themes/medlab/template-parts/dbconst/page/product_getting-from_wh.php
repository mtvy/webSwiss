...
/* 
 * product_getting-from_wh.php
 * main template
 */

//echo 'product_shipment-sent';
//add_log($this->data);
...
//    $ate3['action'] = 'weybillget';
    $ate3['href'] = get_the_permalink(get_the_ID() ) . '?tab=items&act=weybillget&id='.$it['id'].'&return='.urlencode(($this->router )); // curier blank id
