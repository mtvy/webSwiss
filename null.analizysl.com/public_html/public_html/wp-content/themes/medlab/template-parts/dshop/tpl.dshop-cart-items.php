...
//    echo '</td></tr>';
    ...
    <?php
    do_action('ds_cart_total__row_pre', $total, $td_cou = 8);
...
// Обновить корзину
    $page_cart_blank_url = get_the_permalink( 26748 );
?>
  </tbody>
</table>
<div class="">
    ...
    <button class="btn btn-primary" type="submit" name="go" value = "checkout"
            >Продолжить</button>
    <a class="btn btn-primary ml-2 text-white" href="<?=$page_cart_blank_url?>" target="_blank"
            >Печать</a>
    </div>
</form>