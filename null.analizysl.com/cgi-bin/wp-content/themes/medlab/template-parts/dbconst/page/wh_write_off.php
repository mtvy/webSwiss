...
<form class="container-fluid m-2 border border-primary mb-2">
    <div class="row">
        ...
        <div class="col-12">
            ...
            <button type="sumbit" class="btn btn-primary mt-4 -mb-3 btn-block"
                    id="whwoff-create">Создать запрос на списание</button>
        </div>
        <div class="col-12">
            <label for="">Позиции</label>
        </div>
        <div class="col-12 stripped-rows-h" id="writeoffitems_added"> <!- weybillitems_added -->
...
<form class="container-fluid m-2 border border-primary mb-2">
    <div class="row">
        <div class="col-12 mb-4">
            ...
            <button type="sumbit" class="btn btn-primary mt-4 -mb-3 btn-block"
                    id="whwoff-clear">Очистить список списываемых товаров</button>
        </div>
    </div>
...
<form class="container-fluid m-2 border border-primary mb-2">
    <div class="row">
        <div class="col-12">
            ...
            <button type="sumbit" class="btn btn-primary mt-4 -mb-3 btn-block"
                    id="whwoff-add-material">Добавить товар на списание</button>
        </div>
        <div class="col-12">
