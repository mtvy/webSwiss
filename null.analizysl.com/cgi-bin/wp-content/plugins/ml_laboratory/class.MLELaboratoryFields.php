...
/* 
 * class.MLELaboratoryFields.php
 */

include_once DSHOP_DIR.'lend.php';

class MLELaboratoryFields extends lend{
...
//            $maxweigh = $field;
            ...
            $maxweigh = $field_['weigh'];$maxweigh = $field_;
        }
...
//			'id'            => 'ID',
        ...
        $notice = '<div> Добавлено поле "'.$title.'" ['.$name.'] </div>';
        if($fid)
            $notice = '<div> Обновлено поле "'.$title.'" ['.$name.'] </div>';
