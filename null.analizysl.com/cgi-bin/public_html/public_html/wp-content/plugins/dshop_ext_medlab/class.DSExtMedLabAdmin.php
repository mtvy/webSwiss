...
/* 
 * class.DSExtMedLabAdmin.php
 */
include_once DSHOP_DIR.'trait.DShopAdminOptions.php';

class DSExtMedLabAdmin // extends DShopPayment
{
    public $rpage = 'dsextmedlab'; // dspayment
    public $page = 'dsextmedlab.php';
    public $name = 'dsorder';
    use 
            DShopAdminOptions;
...
//    $tabs['display_options2'] = 'Display Options2';
    $tabs = apply_filters('ds_dsorder_settings_extml__tabs', $tabs, $this);
    ?>
        <h2 class="nav-tab-wrapper">
            <?php
                foreach ($tabs as $tn => $tt) { // name => title
                    ?>
            <a href="edit.php?post_type=<?=$this->name?>&page=<?=$this->rpage?>_extml_settings.php&tab=<?=$tn?>" class="nav-tab <?php echo $active_tab == $tn ? 'nav-tab-active' : ''; ?>"><?=$tt?></a>
            <?php
                }
            /*
            ...
            */
            do_action('ds_dsorder_settings_extml__add_tab_link', $this,$this->name,$this->rpage, $active_tab);
            ?>
        </h2>
...
//            ccab_show_sortcodes();
        ...
        do_action('ds_dsorder_settings_extml__do_tab_sections', $this,$this->page, $active_tab);
        submit_button();
            ?>
        </form>
       <?php
        ...
        do_action('ds_dspayment_settings_extml__do_tab_footer_info', $this,$this->page, $active_tab);
       /*
        * 
            <p class="submit">  
...
//            "edit.php?post_type={$this->name}".'&page='.$r_page.'_settings.php', [$this,'page_wrapper']);
        ...
        add_submenu_page( "edit.php?post_type={$this->name}",
                'Настройки заказа', 'Настройки заказа', 'manage_options',
            ''.$r_page.'_extml_settings.php', [$this,'page_wrapper']);
