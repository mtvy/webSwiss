...
//        register_setting( 'general', $option_name);
    ...
    $option_name = 'ds_pageid_price';
    $option_title = 'Id главной страницы прайса';
    $option_field = 'number';
    $items = [];
//    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    ...
    $option_name = 'ds_pageid_order_edit';
    $option_title = 'Id страницы изменения заказа';
    $option_field = 'number';
    $items = [];
//    $items =  explode("\n",esc_attr( get_option('prod_parser_img_patterns') ));//esc_attr
    $arg = array(
