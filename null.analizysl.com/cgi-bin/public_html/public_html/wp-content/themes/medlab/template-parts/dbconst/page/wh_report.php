...
?>
    <div class="row -m-0">
        <div class="col-12">
            <form method="post">
                <input type="hidden" name="action" value="get_wh_report" />
<!--                <input type="hidden" name="act" value="dwnload" />
                <input type="hidden" name="tab" value="<?=$this->tab?>" />-->
                <button class="btn btn-success text-white mb-1" type="submit" >Экспортировать в xls</button>
            </form>
        </div>
    </div>
<?php
