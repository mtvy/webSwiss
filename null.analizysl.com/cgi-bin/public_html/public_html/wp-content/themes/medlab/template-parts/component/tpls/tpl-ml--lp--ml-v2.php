...
$item_tpl_add =<<<c
    <tr>
      <td class="td-pr-code">__code__<br/><br/>
      <b>__price__</b><br/>
      <a class="pl-3 pr-3 text-primary add-to-cart-button" href="#" data-id="__id__">Заказать</a></td>
      <td>__name__</td>
    </tr>
c;
$item_tpl_order_edit =<<<c
    <tr>
      <td class="td-pr-code">__code__<br/><br/>
      <b>__price__</b><br/>
      
        <form method="post" action="__edit_url__?oid=__oid__">
            ...
            <input type="hidden" name="oid" value="__oid__">
            <input type="hidden" name="pid" value="__oiid__">
