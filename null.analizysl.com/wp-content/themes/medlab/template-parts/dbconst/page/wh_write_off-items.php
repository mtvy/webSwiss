...
$DBCWhWriteOffItem = new DBCWhWriteOffItem('items','write_off','write_off_children'); // main weybillget weybill_children DBCWhWeybillItem
    ...
    <div class="row m-0 mb-2">
        <div class="col-12 border border-primary mb-2">
            ...
            //        <form method="post" action="" class="mb-5 mt-5 stripped-rows-h">
                ?>
                <div class="col-12 mb-5 mt-5 stripped-rows-h">
                        <?=implode("\n",$this->form_hidden)?>
                        <?=implode("\n",$rows)?>
                        <div class="row">
